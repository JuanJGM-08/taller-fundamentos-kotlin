...
fun ejecutarBloque4() {
    ...
    // 17. hacemos una cuenta Regresiva
    ...
    // 19. While Infinito (parcialmente)
    var energia = 5
    ...
    do {
        // En una app real pediríamos input,y aquí la simularemos
